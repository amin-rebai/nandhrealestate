...
export interface ContentItem {
  _id: string;
  section: 'home' | 'hero' | 'about' | 'about-home' | 'featured' | 'featured-properties' | 'process-section' | 'services' | 'goals' | 'clients' | 'vision' | 'mission' | 'values' | 'slider' | 'portfolio' | 'contact' | 'stats' | 'cta';
